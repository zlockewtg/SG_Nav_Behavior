...
class SG_Nav_Agent():
    def __init__(self, task_config, args=None):
        ...
        # Align with tools/obj.npy row order; supports goals not in val.json (e.g. open-vocab radio).
    ...
    def _refresh_co_occurrence_priors(self):
        """PSL co-occurrence priors; uniform if goal is outside MP3D training rows (e.g. radio)."""
